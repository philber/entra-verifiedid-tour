...
* **[More secure access to apps and resources](https://go.microsoft.com/fwlink/p/?LinkID=2196454&clcid=0x409&culture=en-us&country=US)** by verifying identity credentials and status to grant least-privilege access for employees, customers, and business partners. 
...
The companion repository provides you with sub folders for the sake of the above walkthrough: 
...
* **[part-3](https://github.com/philber/entra-verifiedid-tour/tree/main/part-3)**: a developer walkthrough to illustrate how to support verifiable credentials with your Azure Active Directory (Azure AD) B2C policies.
